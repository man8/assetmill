...
### Fixed
- Fixed margin and background processing order to apply background before margin, ensuring margin areas use specified background colour instead of remaining transparent
